...
/**
 * IQ used for the signaling of desktop share muting functionality in Jitsi Meet
 * conferences.
 *
 * @author Damian Minkov
 */
public class MuteDesktopIq
    extends IQ
{
    /**
     * Name space of mute packet extension.
     */
    public static final String NAMESPACE = "http://jitsi.org/jitmeet/desktop";
